...
class Agent:
    ...
    # ReAct模式配置
    enable_react_mode: bool = False
    react_style: str = "verbose"  # verbose, concise, hidden
    
    # 提示词组装配置
    base_modules: List[str] = field(default_factory=lambda: ["format_rules", "communication_style"])
    task_instructions_file: str = ""  # 任务指导文件
    
    # 提示词优化配置
    prompt_style: str = "standard"  # compact, standard, detailed
    max_prompt_tokens: int = 1000  # 最大提示词长度
    compress_tools: bool = True  # 是否压缩工具描述
